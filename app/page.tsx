...
export default function Home() {
  return (
    <main className="min-h-screen lightning-bg flex items-start md:items-center justify-center overflow-hidden relative pt-8 md:pt-0">
      ...
      <div className="relative z-10 text-center px-6 md:px-4 max-w-4xl mx-auto mt-8 md:mt-0">
        <motion.div
        ...
        >
          <h1 className="text-2xl md:text-4xl lg:text-6xl xl:text-8xl font-black mb-4 md:mb-6 orbitron">
          ...
          {/* <img
            ...
            alt="Powell Index"
            className="absolute top-full left-1/2 transform -translate-x-1/2 -translate-y-12 md:-translate-y-36 lg:-translate-y-44 w-64 h-64 sm:w-80 sm:h-80 md:w-[40rem] md:h-[40rem] lg:w-[50rem] lg:h-[50rem] xl:w-[60rem] xl:h-[60rem] object-contain opacity-20 z-0 pointer-events-none"
          /> */}
        </motion.div>
        ...
        <motion.div
          ...
          className="flex flex-row justify-center items-center gap-1 md:gap-4 mb-6 md:mb-16 px-2 relative z-10"
        >
          <motion.div
          ...
          >
            <motion.div 
              className="w-32 h-32 sm:w-40 sm:h-40 md:w-80 md:h-80 lg:w-96 lg:h-96 xl:w-[32rem] xl:h-[32rem] flex items-center justify-center mb-2 md:mb-4 relative"
              animate={{
                scale: [1, 1.1, 1],
                rotate: [0, 5, -5, 0]
              }}
            ...
            <h3 className="text-lg md:text-xl font-bold text-pink-400 inter mb-1 md:mb-2 animate-neon-flicker">RATE</h3>
